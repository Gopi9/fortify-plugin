pipeline {
    ...
    stages {
        ...
        stage('translation') {
	      ...
	      script {
                    path = pwd()
                    fortifyTranslate addJVMOptions: '', buildID: 'app', debug: true, excludeList: '', logFile: '', maxHeap: '', projectScanType: fortifyOther(otherIncludesList: '"./**/*.java"', otherOptions: '"./**/.jar"'), verbose: true
	      }
	    }
        }
        stage('scan') {
