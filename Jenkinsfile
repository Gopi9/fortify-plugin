pipeline {
    ...
    stages {
        ...
        stage('translation') {
            steps {
              fortifyTranslate addJVMOptions: '', buildID: 'app', debug: true, excludeList: '', logFile: 'translation.log', maxHeap: '', projectScanType: fortifyAdvanced(advOptions: '\'"-source" "1.8" "./**/*.java"\''), verbose: true
            }
        }
        stage('scan') {
            steps {
