pipeline {
    ...
    stages {
        ...
        stage('translation') {
	      ...
	      script {
                    path = pwd()
               fortifyTranslate addJVMOptions: '', buildID: 'app', debug: true, excludeList: '', logFile: '', maxHeap: '', projectScanType: fortifyAdvanced(advOptions: '\'"-source" "1.8" "-cp" "./**/*.jar" "./**/*.java"\''), verbose: true
